...
invertible rules:
\begin{mathpar}
  \inferrule{{\Gamma,\alpha:\cat C \vdash \cat D}}{\Gamma \vdash \cat C \multimap \cat D}\and

  \inferrule{\Gamma(\alpha_1:\cat C,\alpha_2: \cat D) \vdash\cat E}{\Gamma(\alpha:\cat C \otimes \cat D) \vdash \cat E}

  \inferrule{\Gamma\postfixop \vdash \cat C}{\Gamma \vdash \cat C^{\mathrm{op}}}

  \inferrule{\Gamma \vdash \Phi}{\Gamma \vdash \mathrm{q}(\Phi) : \mathcal U}
\end{mathpar}

...
2-level~\cite{voevodsky12,altenkirchXX} or indexed type
theories~\cite{isaev,linearlf,vakar,krishnaswamibenton}.
...
invertible)~\cite{hofmannstreicher,awodeywarren,voevodsky}. The reason
...
In \cref{sec:syntax} we introduce the syntax of \vett{}.  In
\cref{sec:examples} we demonstrate how to use our syntax for formal
category theory.  In \cref{sec:semantics}, we develop some model theory
...
enriched and internal category theory.  In \cref{sec:discussion}, we

...
demonstrate some basic definitions and theorems. We make no claims to
the originality of the results of this section, as it is well known
that much category theory can be formalized in virtual equipments, we
only show these to demonstrate that the VETT syntax does give a more
familiar syntax to these constructions, while still avoiding the need
for explicit naturality and functoriality side conditions.
...
\begin{lemma}
  ...
  \end{enumerate}
\end{lemma}
The proofs both follow from the unit elimination rule, and we can view
...
Next, we turn to basic universal properties.
\begin{lemma}
...
of profunctors. We show the construction of this isomorphism as follows, giving an example that naturality is simply 
\begin{construction}

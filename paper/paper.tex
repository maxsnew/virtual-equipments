...
In Figure~\ref{fig:admissible}, we describe the admissible typing
rules for the actions of substitution.
...
%% \begin{definition}[Substitution of Objects in Sets]
%%   3
%% \end{definition}
%% \begin{definition}[Substitution of Elements in Elements]
%%   3
%% \end{definition}
...
\begin{figure}
  \begin{mathpar}
    ...
    \inferrule*[right=BoundarySubst]{\Gamma \vdash \xi : Z \to \Xi\and \Gamma \pipe \Xi \vdash R \isaSet}{\Gamma \pipe Z \vdash R[\xi] \isaSet}

    \inferrule*[right=TransSubst]{\Gamma \vdash \phi : \Psi \to \Phi\and \Gamma \pipe \Phi \vdash s : R}{\Gamma \pipe \Psi \vdash s[\phi] : R[\underline \phi]}
  \end{mathpar}
  \begin{align*}

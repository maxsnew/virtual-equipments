...
of categories and profunctors rather than the double category of
categories functors and profunctors. One abstract structure along
...
\citet{carboni-walters,carboni-walters-someonelese}. Some preliminary
work on a proof system for Cartesian bicateogires was presented at
\citet{jonasfreycartesianbicategories}. This bears strong similarities
to our calculus SCT, except that (1) their profunctors may have 0, 1
or more covariant or contravariant variables but (2) they do not have
a term syntax like our natural transformation syntax and (3) they do
not have functors and restriction of profunctors by functors (since
this structure is not present in a Cartesian
bicategory). Semantically, Cartesian bicategories are somewhat less
general than pro-arrow equipments because in general the set of

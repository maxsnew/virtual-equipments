...
\begin{figure}
  ...
  \inferrule
  {\Gamma \pipe d^+\Xi; \alpha : \cat C \vdash  R \\\\ \Gamma \pipe  d^-\Xi; \alpha : \cat C \vdash P}
...
%%       \pendallXdotY {\alpha_1} {\homrallXYtoZ {\alpha_2} {\punitinXfromYtoZ {\cat C} {\alpha_1}{\alpha_2}} {\harrapp Q {\alpha_1}{\alpha_2}}}}
  ...
  \inferrule
  {
   \Gamma\pipe \alpha:\cat C, x:P, \beta:\cat D, y:Q, \gamma:\cat E \vdash t : R\\\\
   \Gamma \pipe\Phi \vdash s : \tensorexistsXwithYandZ {\beta} {P[a/\alpha]}{Q[c/\gamma]}}
  {\Gamma \vdash \tensorelimWfromXtoYkontZ a s b {\alpha.x.\beta.y.\gamma. t} : R[a/\alpha;c/\gamma]}
...
%
First, we demonstrate that a hyperdoctrine of virtual double

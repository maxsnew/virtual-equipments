...
%
The downside is that these algebraic structures are quite complicated,
with a 2-dimensional diagrammatic language that can be quite beautiful
and elegant, but is also seems very far removed from the traditional
formulation of category theory that while complex is at least
described in terms of a concrete notion of sets or types.
...
profunctor along two functors, and modeling this operation as a

...
should would provide a formal treatment of it.
...
expressible in \vett{}, because \vett{} is more restricted, it has more
models, e.g. in internal and enriched categories, so the theorems that
are provable in \vett{} apply in more settings.    

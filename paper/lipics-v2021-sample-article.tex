...
\begin{figure}
  \begin{mathpar}
    \begin{array}{rcl}
      ...
      \textrm{Objects} & a, b, c ::= & \alpha \pipe M a \ldots\\
      \textrm{Sets} & P,Q,R ::= & \ldots \\
      \textrm{Transformations} & s,t,u & ::= & \ldots \\
      \\
      \textrm{Type Context} & \Gamma ::= & \cdot \pipe \Gamma, X : A\\
      \textrm{Cat Context} & \Phi,\Psi ::= & \cdot \pipe \alpha : \cat C \pipe \Phi , x : P , \Psi\\
    \end{array}
  \end{mathpar}

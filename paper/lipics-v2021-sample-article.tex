...
profunctor. This is unique among the multiplicatives in that it
defines a \emph{category} rather than a profunctor. It is a negative
multiplicative but it looks like a positive ??. A functor into the
category of elements $\exists (\alpha; \beta). R$ is equivalent to a
morphism into the functor $R$.
...
Semantically, the graph of a profunctor is simply the category of
elements of the profunctor. Taking the profunctor to be (restrictions
of) the hom profunctor allows us to define the slice, arrow and comma
categories.

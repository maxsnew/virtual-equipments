...
\begin{lemma}[{Yoneda and Co-Yoneda}]
  ...
  Let $P : \harr {\cat C} {\cat D}$. Then the following sets are (naturally) isomorphic to $\harrapp P \alpha \beta$
  \begin{enumerate}
  \item $\tensorexistsXwithYandZ {\beta'} {\harrapp P \alpha {\beta'}} {(\punitinXfromYtoZ {\cat D} {\beta'} {\beta})}$
  \item $\tensorexistsXwithYandZ {\alpha'} {(\punitinXfromYtoZ {C} {\alpha} {\alpha'})} {\harrapp P {\alpha'}{\beta}}$
  \item $\homrallXYtoZ {\beta'} {(\punitinXfromYtoZ {D} {\beta'} {\beta})} {\harrapp P {\alpha} {\beta'}}$
  \item $\homlallXYtoZ {{\alpha'}} {(\punitinXfromYtoZ {C} {\alpha'} {\alpha})} {\harrapp P {{\alpha'}} {\beta}}$
  \end{enumerate}
\end{lemma}
...
\emph{Fubini} theorems about interchange of ends.
...
\begin{definition}[Composition of Morphisms]
  We define composition of morphisms as the following term of type $\hombinary {\alpha_1} {\punitinXfromYtoZ {\cat C}{\alpha_1} {\alpha_2}} {\alpha_2} {\punitinXfromYtoZ {\cat C}{\alpha_2} {\alpha_3}} {\alpha_3} {\punitinXfromYtoZ {\cat C}{\alpha_1} {\alpha_3}}$:
  \[
  \punitelimtoYwithkontZ {\hlambda {\alpha_1}{\alpha_2} \homrallXYtoZ {\alpha_3} {\punitinXfromYtoZ {\cat C} {\alpha_2} {\alpha_3}} {\punitinXfromYtoZ {\cat C} {\alpha_1} {\alpha_3}}} {\lambdaunary {\alpha} {f : \punitinXfromYtoZ {\cat C}{\alpha} {\alpha_3}} {\alpha_3} f}
  \]
\end{definition}
...
We can then use our notion of Hom of profunctors 
...
\begin{definition}
  ...
  $J: \textrm{Functor}\,C'\,C$ be functors. Then the right Kan

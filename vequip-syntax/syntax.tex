...
\begin{mathpar}
  ...
  {\Gamma\pipe\cdot \vdash R : \harr {C} {E}\and
   \Gamma \pipe \Phi \vdash M : \tensorexistsXwithYandZ {\beta:D} P Q\and
   \Gamma\pipe\cdot \vdash N : \coendallXdotY {\alpha:C} {\homrallXYtoZ {\beta:D} P {\homrallXYtoZ {\gamma:E} Q {\harrapp R \alpha\gamma}}}}
  {\Gamma\pipe\Phi \vdash\tensorelimXtoYwithkontZ R M N : \harrapp R A G}
...
Associativity laws:
\begin{enumerate}
\item $\tensorexistsXwithYandZ {\beta} {P} {(\tensorexistsXwithY \gamma Q R)} \cong \tensorexistsXwithYandZ {\gamma} {(\tensorexistsXwithY \beta P Q)} R$

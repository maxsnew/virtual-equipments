...
\begin{mathpar}
    ...
    {A \to_{\cat C} A' \span(\beta^o : \cat D;\gamma : \cat E)}
...
\begin{mathpar}
  ...
  {Q \span(\alpha^o : \cat C; \beta : \cat D)
   \and R \span(\beta^o : \cat D; \gamma : \cat E)}
  {\exists \beta.~Q \odot R \span(\alpha^o : \cat C; \gamma : \cat E)}

...
presence of cotensor judgments. The key property that Hom judgments
allow is that given any variable in context of a term
$\Phi,\alpha,x,\beta,\Psi \vdash M : Q$ we can represent this term as
...
work on single variable contexts.
...
\begin{figure}
  \begin{mathpar}
      ...
      P \triangleleft \Phi,x:R, \gamma:\cat E = \forall \gamma:\cat E. (P \triangleleft \Phi) \triangleleft E\\

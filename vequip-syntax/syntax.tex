...
\begin{mathpar}
    ...
    {A \to_{\cat C} A' \pto(\beta^o : \cat D;\gamma : \cat E)}
...
\begin{mathpar}
  ...
  {Q \pto(\alpha^o : \cat C; \beta : \cat D)
   \and R \pto(\beta^o : \cat D; \gamma : \cat E)}
  {\exists \beta.~Q \odot R \pto(\alpha^o : \cat C; \gamma : \cat E)}

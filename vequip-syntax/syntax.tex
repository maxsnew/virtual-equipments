...
\begin{figure}
  \begin{mathpar}
    ...
    {\Gamma \dtctx}
    {\Gamma \vdash \Phi \vectx}

    \inferrule*[right=Term formation]
    {\Gamma \vdash \Phi \vectx
     \Gamma\pipe \underline \Phi \vdash R \Set}
    {\Gamma \pipe \Phi \vdash t : R}
    ...
    \inferrule*[right=Boundary Map formation]
    {\Gamma \vdash \Psi \vectx \and \Gamma \vdash \Phi \vectx}
...
\begin{figure}
  \begin{mathpar}
    ...
    \inferrule{}{\Gamma \vdash \cdot \vectx}

    \underline \cdot = \cdot

    \inferrule{\Gamma \vdash C : \Sort}{\Gamma \vdash \alpha: C \boundary}

    \inferrule{\Gamma \vdash C : \Sort}{\Gamma \vdash \alpha: C \vectx}
    ...
    \inferrule
    {\Gamma \vdash \Phi \vectx\and
    \Gamma \vdash \Psi \vectx \and
    \Gamma \pipe d^+\Phi, d^- \Psi \vdash R \Set}
    {\Gamma \vdash \Phi, x:R, \Psi \vectx}
...
\begin{figure}
  \begin{mathpar}
    \inferrule
    {}
    {\Gamma\pipe \cdot \vdash \Sort \Set}
...
\begin{figure}
  \begin{mathpar}
    ...
    \inferrule
    {\Gamma \pipe \alpha:\cat C\vdash R \Set}

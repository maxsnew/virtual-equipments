...
\begin{definition}
  ...
  \item Preservation of identity requires proving
    \[ \lambda \alpha. C_r(\textrm{Id}_1(\alpha)) \]
    is equal to
  ...
  \item Preservation of composition requires proving
    ...
    C_t {(\textrm{Id}_0 \alpha)} \triangleleft ((\textrm{Id}_1 \alpha \triangleleft(f, \beta), F_0 \beta, F_1 \beta \triangleleft (g, \gamma)), \textrm{Id}_0 \gamma)
    ) \]
...
\begin{definition}
  ...
  \item Preservation of identity requires proving
    \[ \lambda \alpha. E_r((G \circ F)_1(\alpha)) \]
    is equal to
    \[ \lambda \alpha. (G \circ F)_1 \alpha \triangleleft (C_r\alpha, \alpha) \]

    The right side expands to

    \[ \lambda \alpha. G_1 (F_0 \alpha)\triangleleft ((F_1 \alpha \triangleleft (f, \alpha)), F_0 \alpha) \]

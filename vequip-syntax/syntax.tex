...
\item Next, $I^{-1}$ is a homomorphism automatically since composition
  with a morphism is automatically natural, where $I^{-1}$ is defined as
...
\begin{proof}
  ...
  \item To prove $G_1$ preserves identity we need to show
    \[ {\homrappXtoYatZ {\pendappXtoY I {G_0\beta}} {(\homrappXtoYatZ {\homrappXtoYatZ {\homrappXtoYatZ {\pendappXtoY {Q_t} {G_0\beta}} {\pendappXtoY {C_r} {G_0\beta}} {G_0\beta}} {\pendappXtoY \epsilon {\beta}} \beta} {\pendappXtoY {\pendappXtoY {D_r} {\beta}}} {\beta})} {\beta}} = \pendappXtoY{C_r} {G_0\beta}\]
    which is precisely the $\eta$ principle.

  \item Next, we show $I^{-1}$ is a homomorphism from $\text{Hom}(C)[\text{Id}(C);G]$ to $Q$.
    ...
    %% I^{-1} (f ;C (g ;C G_1 h)) = Q_t f (I^{-1} g) h
    ...
    \begin{align*}
      ...
      \apptrinary {Q_t} \alpha
      {(\appbinary {C_t} \alpha f {\alpha'} g {G_0 \beta'})} {G_0 \beta'}
      {(\appunary {I^{-1}} {G_0 \beta'} {(\appunary {G_1} {\beta'} h \beta)} \beta)} \beta
      {\pendappXtoY {D_r} \beta} \beta
      \\
      &=
      \apptrinary {Q_t} \alpha
      {(\appbinary {C_t} \alpha f {\alpha'} g {G_0 \beta'})} {G_0 \beta'}
      {(\appunary {I^{-1}} {G_0 \beta'} {(\appunary {I} {G_0\beta'} {(\apptrinary {Q_t} {G_0 \beta'} {\pendappXtoY {C_r} {G_0 \beta'}} {G_0 \beta'} {\pendappXtoY \epsilon {\beta'}} {\beta'} h \beta)} \beta)} \beta)} \beta
      {\pendappXtoY {D_r} \beta} \beta
      \\
      &=
      \apptrinary {Q_t} \alpha
      ...
      h \beta\\
      &= \homrappXtoYatZ {\homrappXtoYatZ {\homrappXtoYatZ {\pendappXtoY {Q_t} \alpha} f {\alpha'}} {(\homrappXtoYatZ {\pendappXtoY {I^{-1}} {\alpha'}} {g} {\beta'})} {\beta'}} {h} {\beta}\\
    \end{align*}
